...
DEFAULT_DB_PATH = "/Users/bunny/.openclaw/workspace/cashew/data/graph.db"
...
def generate_complete_session_context(db_path: str = DEFAULT_DB_PATH, 
...
def extract_from_conversation_complete(db_path: str = DEFAULT_DB_PATH,
...
def run_complete_think_cycle(db_path: str = DEFAULT_DB_PATH,
...
def run_complete_sleep_cycle(db_path: str = DEFAULT_DB_PATH,
...
def migrate_to_complete_coverage(db_path: str = DEFAULT_DB_PATH,
...
def explain_complete_system(db_path: str = DEFAULT_DB_PATH, query: str = "test query") -> Dict:
    """
...
def get_complete_system_stats(db_path: str = DEFAULT_DB_PATH) -> Dict:
    """
